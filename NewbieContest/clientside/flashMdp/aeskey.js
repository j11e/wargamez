...
key = [118, 97, 100, 101, 114, 101,116,114,111,115,97,116,97,110,97,115];

Int32Array.prototype.writeBytes = function(bytes, offset, length) {
    offset = offset || 0;
    length = length || bytes.length;
    var max = Math.min(bytes.length, length);

    for (var i=0; i<max; i++) {
        console.log("writing " + bytes[offset + i] + " to index " + i);
        this[i] = bytes[offset + i];
    }
};
...
class AESKey
{
    ...
    constructor(key/*:Int32Array*/) {
        this.state = new Int32Array(16);
        var keyLength = key.length;
        this.key = new Int32Array(16);
    ...
    decrypt(block/*:Int32Array*/, index/*:uint=0*/)
    {
        index = index || 0;
     ...
     //   this.state.position=0;
        ...
        this.addRoundKey(key, this.Nr*Nb*4);
        this.invShiftRows();
    ...
    shiftRows()
    {
        ...
        this.state[0] = Sbox[this.state[0]]; this.state[4] = Sbox[this.state[4]];
        this.state[8] = Sbox[this.state[8]]; this.state[12] = Sbox[this.state[12]];
    
        // rotate row 1
        tmp = Sbox[this.state[1]]; this.state[1] = Sbox[this.state[5]];
        this.state[5] = Sbox[this.state[9]]; this.state[9] = Sbox[this.state[13]]; this.state[13] = tmp;
    
        // rotate row 2
        tmp = Sbox[this.state[2]]; this.state[2] = Sbox[this.state[10]]; this.state[10] = tmp;
        tmp = Sbox[this.state[6]]; this.state[6] = Sbox[this.state[14]]; this.state[14] = tmp;
    
        // rotate row 3
        tmp = Sbox[this.state[15]]; this.state[15] = Sbox[this.state[11]];
        this.state[11] = Sbox[this.state[7]]; this.state[7] = Sbox[this.state[3]]; this.state[3] = tmp;
    };
    ...
    invShiftRows ()
    {
        ...
        // restore row 0
        this.state[0] = InvSbox[this.state[0]]; this.state[4] = InvSbox[this.state[4]];
        this.state[8] = InvSbox[this.state[8]]; this.state[12] = InvSbox[this.state[12]];
    
        // restore row 1
        tmp = InvSbox[this.state[13]]; this.state[13] = InvSbox[this.state[9]];
        this.state[9] = InvSbox[this.state[5]]; this.state[5] = InvSbox[this.state[1]]; this.state[1] = tmp;
    
        // restore row 2
        tmp = InvSbox[this.state[2]]; this.state[2] = InvSbox[this.state[10]]; this.state[10] = tmp;
        tmp = InvSbox[this.state[6]]; this.state[6] = InvSbox[this.state[14]]; this.state[14] = tmp;
    
        // restore row 3
        tmp = InvSbox[this.state[3]]; this.state[3] = InvSbox[this.state[7]];
        this.state[7] = InvSbox[this.state[11]]; this.state[11] = InvSbox[this.state[15]]; this.state[15] = tmp;
    };
    ...
    mixSubColumns ()
    {
        ...
        // mixing column 0
        tmp[0] = Xtime2Sbox[this.state[0]] ^ Xtime3Sbox[this.state[5]] ^ Sbox[this.state[10]] ^ Sbox[this.state[15]];
        tmp[1] = Sbox[this.state[0]] ^ Xtime2Sbox[this.state[5]] ^ Xtime3Sbox[this.state[10]] ^ Sbox[this.state[15]];
        tmp[2] = Sbox[this.state[0]] ^ Sbox[this.state[5]] ^ Xtime2Sbox[this.state[10]] ^ Xtime3Sbox[this.state[15]];
        tmp[3] = Xtime3Sbox[this.state[0]] ^ Sbox[this.state[5]] ^ Sbox[this.state[10]] ^ Xtime2Sbox[this.state[15]];
    
        // mixing column 1
        tmp[4] = Xtime2Sbox[this.state[4]] ^ Xtime3Sbox[this.state[9]] ^ Sbox[this.state[14]] ^ Sbox[this.state[3]];
        tmp[5] = Sbox[this.state[4]] ^ Xtime2Sbox[this.state[9]] ^ Xtime3Sbox[this.state[14]] ^ Sbox[this.state[3]];
        tmp[6] = Sbox[this.state[4]] ^ Sbox[this.state[9]] ^ Xtime2Sbox[this.state[14]] ^ Xtime3Sbox[this.state[3]];
        tmp[7] = Xtime3Sbox[this.state[4]] ^ Sbox[this.state[9]] ^ Sbox[this.state[14]] ^ Xtime2Sbox[this.state[3]];
    
        // mixing column 2
        tmp[8] = Xtime2Sbox[this.state[8]] ^ Xtime3Sbox[this.state[13]] ^ Sbox[this.state[2]] ^ Sbox[this.state[7]];
        tmp[9] = Sbox[this.state[8]] ^ Xtime2Sbox[this.state[13]] ^ Xtime3Sbox[this.state[2]] ^ Sbox[this.state[7]];
        tmp[10]  = Sbox[this.state[8]] ^ Sbox[this.state[13]] ^ Xtime2Sbox[this.state[2]] ^ Xtime3Sbox[this.state[7]];
        tmp[11]  = Xtime3Sbox[this.state[8]] ^ Sbox[this.state[13]] ^ Sbox[this.state[2]] ^ Xtime2Sbox[this.state[7]];
    
        // mixing column 3
        tmp[12] = Xtime2Sbox[this.state[12]] ^ Xtime3Sbox[this.state[1]] ^ Sbox[this.state[6]] ^ Sbox[this.state[11]];
        tmp[13] = Sbox[this.state[12]] ^ Xtime2Sbox[this.state[1]] ^ Xtime3Sbox[this.state[6]] ^ Sbox[this.state[11]];
        tmp[14] = Sbox[this.state[12]] ^ Sbox[this.state[1]] ^ Xtime2Sbox[this.state[6]] ^ Xtime3Sbox[this.state[11]];
        tmp[15] = Xtime3Sbox[this.state[12]] ^ Sbox[this.state[1]] ^ Sbox[this.state[6]] ^ Xtime2Sbox[this.state[11]];
    
      //  this.state.position=0;
        this.state.writeBytes(tmp, 0, Nb*4);
    };
    ...
    invMixSubColumns ()
    {
        ...
        // restore column 0
        tmp[0] = XtimeE[this.state[0]] ^ XtimeB[this.state[1]] ^ XtimeD[this.state[2]] ^ Xtime9[this.state[3]];
        tmp[5] = Xtime9[this.state[0]] ^ XtimeE[this.state[1]] ^ XtimeB[this.state[2]] ^ XtimeD[this.state[3]];
        tmp[10] = XtimeD[this.state[0]] ^ Xtime9[this.state[1]] ^ XtimeE[this.state[2]] ^ XtimeB[this.state[3]];
        tmp[15] = XtimeB[this.state[0]] ^ XtimeD[this.state[1]] ^ Xtime9[this.state[2]] ^ XtimeE[this.state[3]];
    
        // restore column 1
        tmp[4] = XtimeE[this.state[4]] ^ XtimeB[this.state[5]] ^ XtimeD[this.state[6]] ^ Xtime9[this.state[7]];
        tmp[9] = Xtime9[this.state[4]] ^ XtimeE[this.state[5]] ^ XtimeB[this.state[6]] ^ XtimeD[this.state[7]];
        tmp[14] = XtimeD[this.state[4]] ^ Xtime9[this.state[5]] ^ XtimeE[this.state[6]] ^ XtimeB[this.state[7]];
        tmp[3] = XtimeB[this.state[4]] ^ XtimeD[this.state[5]] ^ Xtime9[this.state[6]] ^ XtimeE[this.state[7]];
    
        // restore column 2
        tmp[8] = XtimeE[this.state[8]] ^ XtimeB[this.state[9]] ^ XtimeD[this.state[10]] ^ Xtime9[this.state[11]];
        tmp[13] = Xtime9[this.state[8]] ^ XtimeE[this.state[9]] ^ XtimeB[this.state[10]] ^ XtimeD[this.state[11]];
        tmp[2]  = XtimeD[this.state[8]] ^ Xtime9[this.state[9]] ^ XtimeE[this.state[10]] ^ XtimeB[this.state[11]];
        tmp[7]  = XtimeB[this.state[8]] ^ XtimeD[this.state[9]] ^ Xtime9[this.state[10]] ^ XtimeE[this.state[11]];
    
        // restore column 3
        tmp[12] = XtimeE[this.state[12]] ^ XtimeB[this.state[13]] ^ XtimeD[this.state[14]] ^ Xtime9[this.state[15]];
        tmp[1] = Xtime9[this.state[12]] ^ XtimeE[this.state[13]] ^ XtimeB[this.state[14]] ^ XtimeD[this.state[15]];
        tmp[6] = XtimeD[this.state[12]] ^ Xtime9[this.state[13]] ^ XtimeE[this.state[14]] ^ XtimeB[this.state[15]];
        tmp[11] = XtimeB[this.state[12]] ^ XtimeD[this.state[13]] ^ Xtime9[this.state[14]] ^ XtimeE[this.state[15]];
    
        for( i=0; i < 4 * Nb; i++ )
            this.state[i] = InvSbox[tmp[i]];
    };
    
    // encrypt/decrypt columns of the key
    addRoundKey (key /*:Int32Array*/, offset)
    {
        var idx//:uint;
 ...
 Nb = 4;    // number of columns in the state & expanded key
    
 // TODO:
 //  - move those tables in binary files, then
 //  - [Embed()] them as Int32Array directly.
 ...
 _Xtime2Sbox = [ // combined Xtimes2[Sbox[]]
 ...
 _Xtime3Sbox = [ // combined Xtimes3[Sbox[]]
...
//var i:uint;
Sbox = new Int32Array(_Sbox.length);
InvSbox = new Int32Array(_InvSbox.length);
Xtime2Sbox = new Int32Array(_Xtime2Sbox.length);
Xtime3Sbox = new Int32Array(_Xtime3Sbox.length);
Xtime2 = new Int32Array(_Xtime2.length);
Xtime9 = new Int32Array(_Xtime9.length);
XtimeB = new Int32Array(_XtimeB.length);
XtimeD = new Int32Array(_XtimeD.length);
XtimeE = new Int32Array(_XtimeE.length);
/*
for (i=0;i<256;i++) {
    Sbox[i] = _Sbox[i];
...
Rcon = new Int32Array(_Rcon.length);
/*
